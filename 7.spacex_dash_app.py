...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',
                                ...
                                dcc.Dropdown(id='site-dropdown',
                                             ...
                                             searchable=True  # Allows users to search for sites by typing
                                             ),
                                html.Br(),
                                ...
                                dcc.RangeSlider(id='payload-slider',
                                                ...
                                                marks={i: f'{i}' for i in range(0, 11000, 1000)},  # Adding marks every 1000 Kg
                                                value=[min_payload, max_payload]  # Default selected range based on actual min and max payload
                                                ),
...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        # Create a pie chart showing the total success counts for all sites
